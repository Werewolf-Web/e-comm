...
const Newsletter = () => {
  return (
    <>
    <div 
    style={{height:"330px",width:"auto",backgroundColor:"rgba(240, 240, 240, 0.67)",borderTop:"0.2px black",}}
    >
        <div 
        ...
        <div>
        <div className='d-flex w-auto justify-content-center align-items-center mt-1'>
